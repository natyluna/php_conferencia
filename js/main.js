(function() {
	...
	document.addEventListener('DOMContentLoaded', function() {
		if (document.getElementById('calcular')) {
			...
			function calcularMontos(event) {
				...
				if (regalo.value === '') {
					...
					botonRegistro.disabled = false; //deshabilito el boton
		...
		if (document.getElementById('mapa')) {
			...
			L.marker([-28.471346, -65.80413 ]).addTo(map).bindPopup('GDLWebCAMP 2021').openPopup();
	...
	$(function() {
		...
		$('.cuenta-regresiva').countdown('2021/12/12 09:00:00', function(event) {
