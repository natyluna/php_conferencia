...
<body class="hold-transition skin-blue fixed sidebar-mini" data-elemento="Eventos">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Editar Registros
                <small>completa el formulario para modificar un registro</small>
            </h1>
                            ...
                            <form class="editar-registrado" role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-registrado.php">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Nombre" value="<?php echo $registrado['nombre_registrado']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="eventos" class="eventos clearfix">
                                            ...
                                            <div class="caja row">
                                                ...
                                                <!--  //completa los talleres que habia seleccionado// -->
                                                <?php
                                            ...
                                            <div class="caja clearfix row">
                                                <div class="extras col-md-6">
                                                    ...
                                                    <div class="orden">
                                                        ...
                                                        <input value="<?php echo $boletos['camisas']; ?>" type="number" class="form-control" min="0" id="etiquetas" name="pedido_extra[etiquetas][cantidad]" size="3" placeholder="0">
                                ...
                                <div class="box-footer">
                                    ...
                                    <!-- como no tengo un campo fecha , lo agrego oculto -->
